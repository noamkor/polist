...
export async function GET(
  ...
  const records = await prisma.businessInsurance.findMany({
    where: { businessId },
...
export async function POST(
  ...
  const record = await prisma.businessInsurance.create({
    data: {
      year: data.year,
...
export async function PUT(request: NextRequest) {
  ...
  const record = await prisma.businessInsurance.update({
    where: { id },
    data: {
      year: data.year,
      provider: data.provider || null,
...
export async function DELETE(request: NextRequest) {
  ...
  await prisma.businessInsurance.delete({ where: { id } });
